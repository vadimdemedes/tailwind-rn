...
These commands will create these files:

- **tailwind.config.js** - Tailwind configuration file.
- **input.css** - Entrypoint for Tailwind compiler. It's required to override the output of Tailwind, so that it doesn't generate CSS for resetting styles, which will cause `tailwind-rn` to fail.
